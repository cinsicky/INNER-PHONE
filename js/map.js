			...
			formatter: function(params) {
				...
				if(params.name == 'China') {
					var res = '<div class=lableContent1>All Category</div>' +
						...
						'<div class=circle></div><div class=mainland>Mainland : 18</div>' +
						'div class=circle2></div><div class=taiwan>Taiwan : 44</div>'
					return res;
				}
				...
				if(params.name == 'French') {
					var res = '<div class=lableContent1>All Category</div>' +
						'<div class=lableContent2>French : 1</div>' 
					return res;
				}
				
				if(params.name == 'Austria') {
					var res = '<div class=lableContent1>All Category</div>' +
						'<div class=lableContent2>ustria : 1</div>' 
					return res;
				}
				
				if(params.name == 'Korea') {
					var res = '<div class=lableContent1>All Category</div>' +
						'<div class=lableContent2>Korea : 1</div>' 
					return res;
				}
			},
...
myChart.on('legendselectchanged', function(params) {
	...
	if(params.name == 'All Category') {
		...
		optionbar.yAxis.name = "Number of companies";
